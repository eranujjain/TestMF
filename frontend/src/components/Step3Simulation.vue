  ...
  <div class="simulation-panel">
    ...
    <div class="control-bar">
      <div class="status-group">
        <!-- Twitter-style platform progress -->
        ...
        <!-- Reddit-style platform progress -->
...
const props = defineProps({
  ...
  minutesPerRound: {
    type: Number,
    default: 30 // Default minutes per round
  },
  projectData: Object,
  graphData: Object,
  systemLogs: Array
...
const phase = ref(0) // 0 idle, 1 running, 2 finished
...
const fetchRunStatusDetail = async () => {
  ...
  try {
    ...
    console.warn('Fetch run status detail failed:', err)
  }
}
