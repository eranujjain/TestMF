          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'Chat with anyone in the simulation' }}</span>
            ...
            >
              ...
              <span>Send survey into the simulation</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Fast chat mode for the report agent with 4 professional tools and full MiroFish memory</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Align real-world seed data with simulation state using Global/Local Memory for cross-temporal deep attribution</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Breadth-first traversal on the graph to reconstruct event propagation and capture full information-flow topology</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG instant query API with optimized indexes for node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviews with parallel multi-turn chats to collect unstructured views and mental state</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent to explore the report in depth' : 'Chat with simulated individuals to learn their views' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="Enter the question for all selected respondents..."
                rows="3"
              ></textarea>
            </div>
...
const chatHistoryCache = ref({}) // Cache all chats: { 'report_agent': [], 'agent_0': [], 'agent_1': [], ... }
...
const renderMarkdown = (content) => {
  ...
  // Fix split ordered lists: keep numbering when single-item <ol>s are separated by paragraphs
...
const sendToAgent = async (message) => {
  ...
  if (chatHistory.value.length > 1) {
    const historyContext = chatHistory.value
      ...
      .join('\n')
    prompt = `Here is our prior conversation:\n${historyContext}\n\nMy new question is: ${message}`
  }
  ...
  if (res.success && res.data) {
    // Data path: res.data.result.results is an object map
    // e.g. {"twitter_0": {...}, "reddit_0": {...}} or single platform {"reddit_0": {...}}
...
const loadProfiles = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`Loaded ${profiles.value.length} simulated profiles`)
    }
  } catch (err) {
...
/* Ordered list numbering — CSS counter across multiple ol */
.message-text {
...
/* Blockquote in chat / survey areas */
