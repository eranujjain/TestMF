    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Simulation instance setup</span>
          </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using context, tools pull entities and relations from the knowledge graph, initialize simulated individuals, and ground them in real-world seeds with distinct behavior and memory.
          </p>
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">Expected agents (total)</span>
            </div>
            <div class="stat-card">
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            The LLM uses simulation requirements and real-world seeds to set world time flow, recommendation algorithms, per-agent active hours, posting frequency, event triggers, and related parameters.
          </p>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div v-if="simulationConfig.generation_reasoning" class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">LLM configuration rationale</span>
              </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            From the narrative direction, initial activation events and hot topics are generated automatically to seed the simulation world.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <!-- Round count: shown after config exists and rounds are computed -->
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">Simulation rounds</span>
                <span class="section-desc">MiroFish plans <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> simulated hours; each round represents <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes of real time</span>
              </div>
              ...
              <div v-else class="rounds-content auto" key="auto">
                <div class="auto-info-card">
                  ...
                  <div class="auto-content">
                    ...
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">First run: switch to custom mode to use fewer rounds for a quicker preview and lower failure risk ➝</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              <span class="info-label">Stated age (in-scenario)</span>
              <span class="info-value">{{ selectedProfile.age || '-' }} y/o</span>
            </div>
            <div class="info-item">
              <span class="info-label">Stated gender (in-scenario)</span>
            ...
            <div class="info-item">
              <span class="info-label">Stated MBTI (in-scenario)</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              <div class="dimension-card">
                ...
                <span class="dim-desc">Complete behavior trajectory in this scenario</span>
              </div>
              <div class="dimension-card">
              ...
              <div class="dimension-card">
                <span class="dim-title">Distinctive memories</span>
                <span class="dim-desc">Memories grounded in real-world seeds</span>
              </div>
              <div class="dimension-card">
...
/** Map API display names (Chinese) and codes to canonical stage keys */
...
const normalizePrepareStage = (raw) => {
  if (!raw) return ''
  const s = String(raw).trim()
  if (['reading', 'generating_profiles', 'generating_config', 'copying_scripts'].includes(s)) return s
  return STAGE_NAME_TO_CODE[s] || s
}
...
// State: phase 0 init, 1 personas, 2 config / orchestration, 4 ready
const phase = ref(0)
...
// Round count: default auto; custom slider recommends 40
const useCustomRounds = ref(false)
const customMaxRounds = ref(40)

watch(currentStage, (newStage) => {
  if (newStage === 'reading' || newStage === 'generating_profiles') {
    phase.value = 1
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      if (data.progress_detail) {
        currentStage.value = normalizePrepareStage(
          data.progress_detail.current_stage || data.progress_detail.current_stage_name || ''
        )
        ...
        if (match) {
          currentStage.value = normalizePrepareStage(match[3].trim())
        }
