    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a short text, <span class="highlight-bold">MiroFish</span> can use its real-world seeds to automatically generate a parallel world of up to <span class="highlight-orange">millions of agents</span>. Inject variables from a god’s-eye view and search for <span class="highlight-code">“local optima”</span> under dynamic, complex group interactions.
            </p>
            <p class="slogan-text">
              Rehearse the future in agent swarms; win decisions after many battles<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            The prediction engine is on standby. Upload multiple unstructured files to initialize a simulation run.
          </p>
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Real-world seed extraction & individual/group memory injection & GraphRAG build</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity–relation extraction & persona generation & env agents inject simulation parameters</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction in natural language (e.g. If X announces Y, how might public sentiment shift?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
const startSimulation = () => {
  ...
  // Persist pending upload payload
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    setPendingUpload(files.value, formData.value.simulationRequirement)
    
    // Go to Process with `new` to indicate a new project
    router.push({
      name: 'Process',
...
:root {
  ...
  /* 
    ...
    Ensure these Google Fonts are linked from index.html.
  */
...
.console-box {
  ...
  padding: 8px; /* Inner padding for double-border feel */
}
